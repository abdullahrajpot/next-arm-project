        ...
        <>
            ...
            <div className="footer__two all-footer bg-dark text-light pt-5">
                <div className="container pt-30" style={{ fontSize: '17px' }}>
                    <div className="row  d-flex justify-content-center" style={{ display: 'flex', justifyContent: 'space-between', gap:'180px' }} >
                        <div className="col-xl-2 col-lg-3 col-md-6 md-mb-0">
                        ...
                        <div className="col-xl-2 col-lg-3 col-md-6 ">
                            <div className="footer__two-widget footer-border">
                                ...
                                <div className="footer__two-widget-location">
                                    <div className="footer__two-widget-location-item-info pb-2">
                                        <Link to='/' className='link' >- Cloud services</Link>
                                    </div>
                                    <div className="footer__two-widget-location-item-info pb-2">
                                        <Link to='/about' className='link' >- Cyber Security</Link>
                                    </div>
                                    <div className="footer__two-widget-location-item-info pb-2">
                                        <Link to='/services' className='link' >- Cloud migration</Link>
                                    </div>
                                    <div className="footer__two-widget-location-item-info pb-2">
                                        <Link to='/industries' className='link' >- Software development</Link>
                                    </div>
