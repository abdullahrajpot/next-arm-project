...
import whatsapp_icon from '../../../assets/images/whatsapp1.png';
            ...
            <Col xs={24} lg={10} className="lg-mb-30">
              <div className="contact__two-left">
                ...
                <div className="contact__two-left-item-socialIcon">
                  <Text style={{ fontSize: '20px', fontWeight: "600" }}>Contacts</Text>
                  <ul style={{ display: 'flex', gap: '3px', listStyle: 'none', marginTop: '19px' }}>
                    <li>
                      <a href='https://wa.me/917993725394' target='blank'>
                        <Image className='icons' src={whatsapp_icon} preview={false} width={isMobile ? '30px' : '50px'} style={{ border: '1px solid rgba(235, 219, 219, 0.811)', borderRadius: '23px', padding: '10px', boxShadow: '0px 10px 20px rgba(0, 0, 0, 0.15)' }} />
                      </a>
                    </li>
                    <li>
