...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceId = 'service_4dt1v6h';
              ...
              <div className="contact__two-right">
                ...
                <div className="contact__two-right-form">
                  <form onSubmit={handleSubmit }>
                    <Row gutter={[16, 16]}>
                      <Col xs={24} md={12}>
                        <Input className='p-3' type="text" name="name" placeholder="Full Name" onChange={(e) => setName(e.target.value)} required="required"
                          style={{ paddingRight: '40px' }} />
                        <i className="fa-regular fa-user px-2"
                          style={{
                            position: 'absolute', right: '10px', top: '50%',
                            transform: 'translateY(-50%)', color: '#0185c3'
                          }}></i>                      </Col>
                      <Col xs={24} md={12}>
                        <Input className='p-3' type="email" name="email" onChange={(e) => setEmail(e.target.value)} placeholder="Email Address" required="required"
                          style={{ paddingRight: '40px' }} />
                      ...
                      <Col xs={24} md={12}>
                        <Input className='p-3' type="text" name="phone" onChange={(e) => setPhone(e.target.value)} placeholder="Phone"
                          style={{ paddingRight: '40px' }} />
                        <i className="fa-solid fa-phone px-2"
                          style={{
                            position: 'absolute', right: '10px', top: '50%',
                            transform: 'translateY(-50%)', color: '#0185c3'
                          }}></i>                      </Col>
                      <Col xs={24} md={12}>
                        <Input className='p-3' type="text" name="subject" onChange={(e) => setSubject(e.target.value)} placeholder="Subject"
                          style={{ paddingRight: '40px' }} />
                        <i className="fa-regular fa-file px-2"
                          style={{
                            position: 'absolute', right: '10px', top: '50%',
                            transform: 'translateY(-50%)', color: '#0185c3'
                          }}></i>                      </Col>
                      <Col xs={24}>
                        <Input.TextArea name="message" placeholder="Message" onChange={(e) => setMessage(e.target.value)} rows={4}
                          style={{ paddingRight: '40px' }} />
                        <i className="fa-regular fa-comments px-2"
                          style={{ position: 'absolute', right: '10px', top: '15px', color: '#0185c3' }}></i>
                      </Col>
                      <Col xs={24}>
                        <Button className="btn-one" onClick={handleSubmit} block type="submit" name="submit" defaultValue="Submit"
                          style={{
      ...
      <div className='container-fluid'>
        <div className="row ">
          <div className="col mt-5">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15231.807945962444!2d78.39966128576624!3d17.366043233544747!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb965aa67155fd%3A0xd2c644d78ef82af1!2sFort%20View%20Rd%2C%20Upperpally%2C%20Hyderabad%2C%20Telangana%20500030%2C%20India!5e0!3m2!1sen!2s!4v1728126174665!5m2!1sen!2s" width="100%" height="400" style={{ border: "0" }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </div>
